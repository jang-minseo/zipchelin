            ...
            <div class="tabContWrap">
                <div id="tabAll" class="tabCont show">
                    <ul class="imgLists  mypostList">
                        ...
                        <li class="listItem mypostItem imgwrap">
                            <div class="chkWrap">
                                <input type="checkbox" class="chkBox" name="chkItem" id="listChk02">
                                <label for="listChk02"></label>
                            </div>
                            <div class="contBox">
                                <a href="/front/html/community/myrecipe_post.html">
                                    <span class="postDate">2023.10.17 00:00</span>
                                    <h6>생명을 불어 넣는</h6>
                                    <p>모래뿐일 것이다 이상의 꽃이 없으면 쓸쓸한 인간에 남는 것은 영락과 부패 뿐이다 낙원을 쓸쓸한 인간에 남는 것은 영락과 부패 뿐이다</p>
                                    <ul class="accList">
                                        <li class="accItem">
                                            <span class="icon material-symbols-outlined">visibility</span>268
                                        </li>
                        ...
                        <li class="listItem mypostItem imgwrap">
                            <div class="chkWrap">
                                <input type="checkbox" class="chkBox" name="chkItem" id="listChk03">
                                <label for="listChk03"></label>
                            </div>
                            <div class="contBox">
                                <a href="/front/html/community/myrecipe_post.html">
                                    <span class="postDate">2023.10.17 00:00</span>
                                    <h6>생명을 불어 넣는</h6>
                                    <p>모래뿐일 것이다 이상의 꽃이 없으면 쓸쓸한 인간에 남는 것은 영락과 부패 뿐이다 낙원을</p>
                                    <ul class="accList">
                                        <li class="accItem">
                                            <span class="icon material-symbols-outlined">visibility</span>268
                                        </li>
                        ...
                        <li class="listItem mypostItem imgwrap">
                            <div class="chkWrap">
                                <input type="checkbox" class="chkBox" name="chkItem" id="listChk04">
                                <label for="listChk04"></label>
                            </div>
                            <div class="contBox">
                                <a href="/front/html/community/myrecipe_post.html">
                                    <span class="postDate">2023.10.17 00:00</span>
                        ...
                        <li class="listItem mypostItem imgwrap">
                            <div class="chkWrap">
                                <input type="checkbox" class="chkBox" name="chkItem" id="listChk05">
                                <label for="listChk05"></label>
                            </div>
                            <div class="contBox">
                                <a href="/front/html/community/myrecipe_post.html">
                                    <span class="postDate">2023.10.17 00:00</span>
                        ...
                        <li class="listItem mypostItem imgwrap">
                            <div class="chkWrap">
                                <input type="checkbox" class="chkBox" name="chkItem" id="listChk06">
                                <label for="listChk06"></label>
                            </div>
                            <div class="contBox">
                                <a href="/front/html/community/myrecipe_post.html">
                                    <span class="postDate">2023.10.17 00:00</span>
                            ...
                            <div class="imgBox align"><img src="${contextPath}/resource/images/none.png" alt="이미지 없음"></div>
                        </li>
                    </ul>
                    <div class="paging">
                        <ul>
